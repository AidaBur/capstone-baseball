...
# SECTION 1: Focus Year 
st.header("Focus Year")
...
# SECTION 2: TRENDS ACROSS YEARS
st.markdown("---")
st.header("🌍 Statistics Across All Years")
...
# SECTION 3: TEAM-BASED VISUALIZATION
st.markdown("---")
st.header("🏟️ Team-Based Visualizations")

selected_team_stat = global_stat
